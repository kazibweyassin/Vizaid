...
const domesticTours = tourPackages.filter((tour) => tour.type === 'domestic');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Domestic Tours - Discover Uganda
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Explore the Pearl of Africa with our carefully curated domestic tour packages.
            From gorilla trekking to wildlife safaris, experience the best of Uganda.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
              ...
              <TourForm tourType="domestic" />
            </div>
          </div>

          {/* Featured Tours */}
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Featured Domestic Tours</h2>
              ...
              {domesticTours.map((tour, index) => (
                ...
                >
                  <Link href={`/services/tours/${tour.id}`}>
                    <div className="border border-[var(--brand-gold)] rounded-lg overflow-hidden hover:shadow-lg transition-all duration-300 group cursor-pointer bg-[var(--background)]">
