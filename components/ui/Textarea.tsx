...
export default function Textarea({ label, error, variant = 'light', className, ...props }: TextareaProps) {
  ...
  return (
    <div className="w-full">
      ...
      <textarea
        className={cn(
          'w-full px-4 py-2 rounded-lg resize-none outline-none transition-colors',
          isDark
